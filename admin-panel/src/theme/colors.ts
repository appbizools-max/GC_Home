/**
 * GC HOME+ — Global Brand Color Tokens (Admin Panel)
...
export const BRAND_COLORS = {
  ...
  primaryGreen: '#123D2A', // Primary Deep Green (active navigation, primary buttons, headers)
  deepGreen: '#123D2A',    // Primary Deep Green
  softGreen: '#6FAF72',    // Primary Soft Green (secondary actions, highlights, cards)
  lightGreen: '#EAF5EC',   // Light Green (subtle backgrounds, pill badges)
  ...
  charcoal: '#171A18',     // Black / Charcoal (main typography, titles, data headers)
  white: '#FFFFFF',        // White (data tables, cards, sidebar background)
  background: '#F8FAF8',   // Background (dashboard background)
